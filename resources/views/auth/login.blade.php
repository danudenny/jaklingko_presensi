    ...
    <div class="fixed inset-0 bg-gray-100 flex items-center justify-center">
        <div class="w-full sm:max-w-md px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative mt-1">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full pl-10" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="your.email@example.com" />
                    </div>
            ...
            <div class="mt-8 border-t border-gray-200 pt-6">
                <h3 class="text-sm font-medium text-gray-700 mb-4 text-center">Demo Login Options</h3>
                <div class="grid grid-cols-2 gap-4">
                    <button type="button" 
                            onclick="document.getElementById('email').value='admin@jaklingko.com';document.getElementById('password').value='password';" 
                            class="flex items-center justify-center px-4 py-2 bg-purple-100 text-purple-700 rounded-md hover:bg-purple-200 transition">
                    ...
                    <button type="button" 
                            ...
                            class="flex items-center justify-center px-4 py-2 bg-green-100 text-green-700 rounded-md hover:bg-green-200 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <p class="mt-3 text-xs text-gray-500 text-center">Click a button to prefill credentials, then click Sign in.</p>
            </div>
            @endif
