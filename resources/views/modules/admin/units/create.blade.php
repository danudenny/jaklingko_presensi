...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <form action="{{ route('units.store') }}" method="POST" id="create-unit-form">
            @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <input type="radio" id="is_pool_yes" name="is_pool" value="1" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" checked>
                            <label for="is_pool_yes" class="ml-2 block text-sm text-gray-700">Unit Milik Sendiri (Pool)</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" id="is_pool_no" name="is_pool" value="0" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
            ...
            <div id="pool-unit-fields" class="mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="unit_reg" id="unit_reg" value="{{ old('unit_reg') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="date" name="expired_stnk" id="expired_stnk" value="{{ old('expired_stnk') }}" 
                    ...
                    <div>
                        ...
                        <input type="date" name="expired_kir" id="expired_kir" value="{{ old('expired_kir') }}" 
                    ...
                    <div>
                        ...
                        <input type="date" name="expired_kp" id="expired_kp" value="{{ old('expired_kp') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="kir" id="kir" value="{{ old('kir') }}" 
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3" id="route-cards-container">
                        ...
                        <div class="route-card relative border rounded-md p-3 hover:border-indigo-500 cursor-pointer transition-all duration-200 @if(in_array($route->id, old('route_ids', []))) selected bg-indigo-50 border-indigo-500 @endif" data-route-id="{{ $route->id }}">
                            <div class="flex flex-col">
                                <span class="text-sm font-medium">{{ $route->code }}</span>
                                <span class="text-xs text-gray-500">{{ $route->name }}</span>
                            </div>
                            <div class="absolute top-2 right-2 text-indigo-600 route-check-icon @if(!in_array($route->id, old('route_ids', []))) hidden @endif">
