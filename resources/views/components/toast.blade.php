@props(['id' => 'toast', 'type' => 'success', 'message' => '', 'duration' => 3000])
...
<div 
    ...
    @toast.window="
        ...
        setTimeout(() => { show = false }, $event.detail.duration || {{ $duration }})
    "
    id="{{ $id }}"
    class="fixed top-4 right-4 z-50 p-4 rounded-md shadow-lg max-w-md"
    :class="{
